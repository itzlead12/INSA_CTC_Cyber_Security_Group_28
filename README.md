...
This project is designed as a **cloud-based SaaS platform**, where multiple websites can register, get their own API key, and route traffic through the WAF for real-time protection, logging, and analytics.  
